...
//!
//! Relocated from `app/squad-tauri/src/agent_store/{routines,routine_runs}.rs`
...
pub(crate) fn ensure_squad_dir(root: &Path) -> CoreResult<()> {
    let dir = root.join(".squad");
