...
//!
//! Lives in `squad-terminal-manager` (not `squad-claude-installer`)
...
//! dependency cycle through `squad-ui-events` (which depends on
//! `squad-terminal-manager` for `FeedItem`).
//!
