...
use chrono::Timelike;
use squad_events::{EventQueueHandle, SquadInput};
...
/// Runs a periodic heartbeat, pushing `SquadInput::heartbeat` into the queue.
...
impl HeartbeatRunner {
    ...
    async fn run(
        ...
        loop {
            ...
            let mut input = SquadInput::heartbeat(&config.prompt);
