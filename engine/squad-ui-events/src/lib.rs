...
//!
//! This crate is transport-neutral. Producers construct `SquadEvent`
...
pub enum SquadEvent {
    ...
    /// watch by `squad_composio::connection_watcher`. Frontend
...
impl EventSink for NoopEventSink {
    fn emit(&self, _event: SquadEvent) {}
}
...
pub struct BroadcastEventSink {
    tx: broadcast::Sender<SquadEvent>,
}
...
impl BroadcastEventSink {
    ...
    pub fn subscribe(&self) -> broadcast::Receiver<SquadEvent> {
        self.tx.subscribe()
    }
...
mod tests {
    ...
    async fn broadcast_sink_delivers_to_subscribers() {
        ...
        matches!(e1, SquadEvent::Toast { .. });
        matches!(e2, SquadEvent::Toast { .. });
    }
