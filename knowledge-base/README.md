...
| [files-first.md](files-first.md) | `.squad/` layout, atomic writes, schemas, AI-native reactivity |
...
| [engine-server.md](engine-server.md) | `squad-engine` binary — config, startup handshake, supervision, deployment |
